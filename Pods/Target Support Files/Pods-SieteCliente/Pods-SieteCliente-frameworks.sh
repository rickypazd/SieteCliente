...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CRGradientNavigationBar/CRGradientNavigationBar.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FeelingsView/FeelingsView.framework"
